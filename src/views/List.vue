<template>
    <div>
        ...
        <div class="content">
            <ul class="book-list">
                <router-link tag="li" :to="{name:'detail',params:{bid:book.bookId}}" class="book" v-for="book in bookList" :key="book.bookId">
                    ...
                    <div class="info">
                        ...
                        <div class="del" @click.stop="del(book.bookId)">删除</div>
                    </div>
                </router-link>
            </ul>
